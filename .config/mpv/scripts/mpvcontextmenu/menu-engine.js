 ...
 *
 * Setup/Requirements:
 * - Check https://gitlab.com/carmanaught/mpvcontextmenu for further setup instructions
 *
...
function doMenu(menuList, menuName, x, y, menuPaths, menuIndexes) {
    ...
    // to the buildList array to make sure we always rebuild the whole menu structure on
