...
Item {
  ...
  readonly property int labelSize: Commons.Style.font.bodySmall
  readonly property int captionSize: Commons.Style.font.bodySmall
  ...
  function widgetContentColor(settings, fallback) { return ink; }
