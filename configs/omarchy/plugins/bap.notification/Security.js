...
// Omarchy toasts carry the click command as hint omarchy-exec-argv: screenshot
// editors and crash diagnosis (omarchy-agent-crash). Stock omarchy.notifications
// runs whatever argv omarchy-action sends. App names are claims
// (docs/THREAT_MODEL.md), so this parser allowlists the programs Omarchy
// actually launches and rejects everything else.
