...
Ui.Panel {
  ...
  moduleName: "bap.pacman-workspaces"
  manageIpc: false
  ...
  WorkspaceService { id: localWorkspaceService }
  property var workspaceService: (bar && bar.shell
    && typeof bar.shell.serviceFor === "function"
    ? bar.shell.serviceFor("bap.pacman-workspaces") : null) || localWorkspaceService
  ...
  readonly property string displayMode: "full"
  ...
  readonly property string renderStyle: "pacman"
  ...
  readonly property color pacmanActiveColor: root.pacmanThemeColor
  readonly property color pacmanOccupiedColor: pacmanActiveColor
  readonly property color pacmanEmptyColor: pacmanActiveColor
  readonly property color pacmanHoverColor: pacmanActiveColor
  ...
  readonly property real workspaceContentWidth: {
    ...
    for (var i = 0; i < workspaceRepeater.count; i++) {
      ...
      var size = root.vertical && item ? item.implicitHeight : (item ? item.implicitWidth : 0)
  ...
  // Pacman uses the standard widget accent color
  readonly property color pacmanThemeColor: root.widgetInk

  function workspaceColor(idValue) {
    return root.tokens ? root.tokens.ink : "#ffffff"
  }
  ...
  function pacmanCenterX(id) {
    ...
    return root.vertical
      ? workspaceRow.y + item.y + item.height / 2
      : workspaceRow.x + item.x + item.width / 2
  }
  ...
  Item {
    ...
    implicitWidth: root.vertical ? (root.bar ? root.bar.barSize : Commons.Style.space(28)) : (root.workspaceContentWidth + 2 * root.workspacePadding)
    implicitHeight: root.vertical ? (root.workspaceContentWidth + 2 * root.workspacePadding) : (root.bar ? root.bar.barSize : Commons.Style.space(28))
    width: implicitWidth
    ...
    Item {
      ...
      Shape {
        ...
        ShapePath {
          strokeColor: root.workspaceColor(root.focusedWorkspaceId)
          strokeWidth: 1
    ...
    Grid {
      ...
      rows: root.vertical ? root.displayedWorkspaceIds.length : 1
      columns: root.vertical ? 1 : root.displayedWorkspaceIds.length
      width: root.vertical ? implicitWidth : root.workspaceContentWidth
      height: root.vertical ? root.workspaceContentWidth : implicitHeight
      ...
      Repeater {
        ...
        delegate: Item {
          ...
          readonly property bool urgent: workspaceInfo.urgent === true || workspaceInfo.needsAttention === true
          readonly property color cellColor: root.workspaceColor(modelData)
          readonly property int numberWidth: Commons.Style.space(20)

          readonly property real dynamicSize: root.renderStyle === "numbers" ? Commons.Style.space(22)
          ...
          implicitWidth: root.vertical ? workspaceSurface.width : dynamicSize
          implicitHeight: root.vertical ? dynamicSize : workspaceSurface.height
          ...
          Rectangle {
            ...
            radius: height / 2
            color: Qt.rgba(cellColor.r, cellColor.g,
              cellColor.b,
          ...
          Rectangle {
            ...
            color: cell.focused || cell.occupied
              ? cellColor : Qt.rgba(cellColor.r,
                cellColor.g, cellColor.b, 0.25)
            Behavior on width { NumberAnimation { duration: 200; easing.type: Easing.OutCubic } }
          }
          ...
          Rectangle {
            ...
            Text {
              ...
              color: cell.focused
                ? cellColor
                : Qt.rgba(cellColor.r, cellColor.g,
                  cellColor.b, cell.occupied ? 0.5 : 0.28)
          ...
          Text {
            ...
            color: Qt.rgba(cellColor.r, cellColor.g,
              cellColor.b, cell.focused ? 1 : cell.occupied ? 0.7 : 0.3)
          ...
          PacmanWorkspaceMarker {
            ...
            urgent: cell.urgent
            activeColor: cell.cellColor
            occupiedColor: Qt.rgba(cell.cellColor.r, cell.cellColor.g, cell.cellColor.b, 0.6)
            emptyColor: root.tokens ? root.tokens.sumi : "#666666"
            hoverColor: root.tokens ? root.tokens.ink : "#ffffff"
            pacmanColor: root.pacmanThemeColor
          }
    ...
    Item {
      ...
      z: 4
      x: root.vertical ? Math.round((parent.width - width) / 2) : root.pacmanTravelX - width / 2
      y: root.vertical ? root.pacmanTravelX - height / 2 : Math.round((parent.height - height) / 2)
      ...
      Item {
        ...
        transform: Scale {
          ...
          xScale: root.vertical ? 1 : root.pacmanTravelDirection
