...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/bap/.config/opencode
                  → checks /home/bap/.config/opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/bap/.config/opencode/gsd-core
                  → writes to /home/bap/.config/opencode/gsd-core/hooks/
