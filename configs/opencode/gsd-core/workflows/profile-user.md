...
Key references:
- @/home/bap/.config/opencode/gsd-core/references/ui-brand.md (display patterns)
- @/home/bap/.config/opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/bap/.config/opencode/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/bap/.config/opencode/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/bap/.config/opencode/gsd-core/USER-PROFILE.md" "/home/bap/.config/opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/bap/.config/opencode/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/bap/.config/opencode/gsd-core/references/user-profiling.md`
...
Reference: @/home/bap/.config/opencode/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/bap/.config/opencode/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/bap/.config/opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/bap/.config/opencode/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/bap/.config/opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/bap/.config/opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/home/bap/.config/opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /home/bap/.config/opencode/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/bap/.config/opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.opencode/AGENTS.md>
  ✓ Global AGENTS.md        /home/bap/.config/opencode/AGENTS.md
```
