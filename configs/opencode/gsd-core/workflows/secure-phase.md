...
```
Agent(
  prompt="Read /home/bap/.config/opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/bap/.config/opencode/gsd-core/templates/SECURITY.md`
