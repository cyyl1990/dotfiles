...
ones). Reference: @/home/bap/.config/opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/bap/.config/opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/bap/.config/opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/bap/.config/opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/bap/.config/opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/bap/.config/opencode/gsd-core/templates/spec.md.
