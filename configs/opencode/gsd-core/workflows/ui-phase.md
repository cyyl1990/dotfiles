...
```markdown
Read /home/bap/.config/opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/bap/.config/opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/bap/.config/opencode/agents/gsd-ui-checker.md for instructions.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/bap/.config/opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/bap/.config/opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/bap/.config/opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
