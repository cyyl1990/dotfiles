...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/bap/.config/opencode/.gsd-surface.json`
(sibling to `/home/bap/.config/opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/bap/.config/opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/bap/.config/opencode/skills`).
...
`/home/bap/.config/opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/bap/.config/opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/bap/.config/opencode/.gsd-surface.json`
Install profile marker: `/home/bap/.config/opencode/.gsd-profile`
Skill dirs: `/home/bap/.config/opencode/skills/gsd-*/`
Engine module: `/home/bap/.config/opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/bap/.config/opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
